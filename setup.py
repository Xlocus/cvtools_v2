...
def get_extensions():
    ...
    if torch.cuda.is_available() or os.getenv('FORCE_CUDA', '0') == '1':
        ...
        op_files = glob.glob('./cvtools/ops/csrc/pytorch/*')
        extension = CUDAExtension
    else:
        print(f'Compiling {ext_name} without CUDA')
        op_files = glob.glob('./cvtools/ops/csrc/pytorch/*.cpp')
        extension = CppExtension

    include_path = os.path.abspath('./cvtools/ops/csrc')
    ext_ops = extension(
        name=ext_name,
        sources=op_files,
...
setup(
    name='cvtools',
    version=get_version(),
    description='Computer Vision Operations Library',
